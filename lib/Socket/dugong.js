...
class kikyy {
    ...
    async handleInteractive(content, jid, quoted) {
        ...
        // and not tested against a live WhatsApp Business account.
        if (carouselMessage) {
    ...
    // Ported from xata-bail's luxu.js (imup class) — the two message types
    // dugong.js didn't cover yet.
