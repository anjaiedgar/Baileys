...
exports.CompanionWebClientType = void 0;
...
function getCompanionWebClientType([os, browserName]) {
...
function getCompanionPlatformId(browser) {
    return getCompanionWebClientType(browser).toString();
}
function buildPairingQRData(ref, noiseKeyB64, identityKeyB64, advB64, browser) {
