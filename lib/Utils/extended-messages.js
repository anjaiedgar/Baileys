"use strict";
// Parsers for incoming messages of the types added in this fork that
// aren't covered by the default `getContentType`/`extractMessageContent`
// helpers (which only tell you *which* field is present, not how to read
// it). Each parser returns a plain, easy-to-use object instead of the raw
// proto shape.
//
// NOTE: like the raw-passthrough sending support in Socket/messages-send.js,
// these have been written to match WAProto.proto exactly but have **not**
// been verified against payloads from a live WhatsApp client — the newest
// fields (V4-V6 polls, split payment, newsletter admin profile, etc.) are
// rare enough that real-world examples were not available to test against.
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseExtendedMessageContent = exports.EXTENDED_MESSAGE_TYPES = void 0;
...
exports.EXTENDED_MESSAGE_TYPES = [
    'spoilerMessage',
    'liveLocationMessage',
    'groupInviteMessage',
    'eventInviteMessage',
 ...
 * everything else).
 */
const parseExtendedMessageContent = (content) => {
    if (!content) {
        return undefined;
    }
...
exports.parseExtendedMessageContent = parseExtendedMessageContent;
